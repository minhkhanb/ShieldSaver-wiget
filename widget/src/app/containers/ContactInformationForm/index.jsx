...
class ContactInformationFrom extends Component {
  constructor(props) {
    super(props);
    this.state = {
      loading: false,
    ...
    return (
      <div className="container justify-content">
        <div className="text-center">
          ...
          <h6>
            {t('contact_information.step_title')}
          </h6>
        </div>
        <form style={{ textAlign: 'left' }}>
          <div className="">
            ...
            <div className="col-xm-12 col-sm-12 col-md-5 content-inline align-top">
              <InputField
                type="text"
                name='phone'
          ...
          <div className="row">
            <div className="form-group text-center col-xm-12 col-sm-4 offset-sm-4">
              <Button primary block name="login" text="NEXT" type='Button' onClick={this.processContactInfo}/>
            </div>
          </div>
        </form>
      </div>
...
export default enhance(connect(mapStateToProps, mapDispatchToProps)(ContactInformationFrom));
